...
import com.example.model.MobileRowMapper;
...
public class MobileMYSQLService implements MobileRepository
{
	...
	{
		List<Mobile> mobileList =db.query("selected * from mobile" , new MobileRowMapper());
	...
	public Mobile getMobileById(int mobileId) 
	{
		try
		{
			Mobile mobile=db.queryForObject("select * from mobile where id=?", new MobileRowMapper());
			return mobile;
		}
		catch(Exception e)
		{
	...
	public Mobile addMobile(Mobile mobile) 
	{
		...
		Mobile newMobile=db.queryForObject("select * from mobile where name=? and image=?",new 
				MobileRowMapper(),mobile.getName(),mobile.getImage());
		return newMobile;
	}
